  ...
  return (
    <section id={id}>
      ...
      <ProjectCard
        ...
        description="We create dynamic map animation videos using After Effects, GeoLayers 3, and Premiere Pro, leveraging OpenStreetMap data for accuracy. Our visuals are engaging, data-driven, and optimized for storytelling, audience retention, and broadcast-quality results."
      ...
      <ProjectCard
        ...
        description="Edits focusing on documentary-style animation using Adobe After Effects and Premiere Pro, leveraging advanced 3D camera techniques to create dynamic motion and immersive storytelling. Designed smooth scene transitions, layered visual effects, and cinematic pacing to enhance narrative impact, delivering a professional, high-quality final render optimized for both online platforms and large-screen presentations."
      ...
      <ProjectCardWithSlider
        ...
        description="Created engaging, data-driven maps using Mapbox and MapTiler. Drawing inspiration from creators such as CaspianReport, Johnny Harris, and Knowledgeia, we design cinematic visuals tailored for storytelling, documentaries, and professional presentations."
