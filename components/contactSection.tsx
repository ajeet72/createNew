  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://www.form-to-email.com/api/s/ZlZk3lJGEN95",
        {
          method: "POST",
          headers: {
        ...
        <div className="max-w-6xl w-full flex flex-col md:flex-row md:space-x-12 space-y-12 md:space-y-0">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 leading-tight">
              You don’t know us. <br /> <span className="text-[#fdba80]">We don’t know you. </span><br />Let’s change that.
            </h1>
            <p className="text-base sm:text-lg text-gray-300 mb-8">
              Drop us a message and let’s see what we can create together.            </p>
            <motion.div
            ...
            >
              ...
              >
                <MailIcon className="text-[#fdba80]" />
                <a
                  href="mailto:createnew.reach@gmail.com"
                  className="hover:text-slate-400 transition-colors duration-300"
                >
                  createnew.reach@gmail.com
                </a>
              </motion.div>
              <motion.div
                className="flex items-center space-x-3"
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                <MessageCircle className="text-[#fdba80]" />
                <a
          ...
          {/* Right: Form Section */}
          <motion.form
            className="w-full md:w-1/2 bg-[#003336] p-6 sm:p-8 rounded-xl shadow-md space-y-6"
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full bg-[#032426] text-white border border-gray-700 rounded-md px-4 py-2 focus:outline-none focus:ring-1 focus:ring-[#fdba80]"
              />
            </div>
            <div>
            ...
            <button
              ...
              className={`cursor-pointer w-full py-3 rounded-md font-semibold transition-colors ${
                isSubmitting
                  ? "bg-gray-500 text-[#06113d]"
                  : isSuccess
                  ? "bg-[#fdba80] text-[#06113d]"
                  : "bg-[#fdba80] hover:bg-[#a97f5b] text-[#06113d]"
              }`}
